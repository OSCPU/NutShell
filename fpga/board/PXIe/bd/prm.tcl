...
proc create_hier_cell_hier_pardcore_peripheral { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_pardcore_mmio_M02_AXI [get_bd_intf_pins axi_dma_pardcore/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_pardcore_mmio/M02_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_pardcore_mmio_M03_AXI [get_bd_intf_pins axi_interconnect_pardcore_mmio/M03_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net axi_protocol_convert_0_M_AXI [get_bd_intf_pins axi_interconnect_pardcore_mmio/M00_AXI] [get_bd_intf_pins xdma_0/S_AXI_B]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_AXILITE_MMIO_1 [get_bd_intf_ports AXI_MMIO] [get_bd_intf_pins hier_pardcore_peripheral/S_AXILITE_MMIO]
  ...
  connect_bd_intf_net -intf_net S_AXI_MEM_1 [get_bd_intf_ports AXI_MEM] [get_bd_intf_pins hier_prm_peripheral/S_AXI_MEM]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_ports AXI_DMA] [get_bd_intf_pins hier_pardcore_peripheral/M_AXI_DMA]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins hier_clkrst/resetn] [get_bd_pins hier_pardcore_peripheral/sys_rst_n] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_prm_peripheral/axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x80010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_prm_peripheral/corerst/S_AXI/Reg] SEG_pardcore_corerst_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/axi_dma_pardcore/Data_SG] [get_bd_addr_segs AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/axi_dma_pardcore/Data_MM2S] [get_bd_addr_segs AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/axi_dma_pardcore/Data_S2MM] [get_bd_addr_segs AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_pardcore_peripheral/xdma_0/M_AXI_B] [get_bd_addr_segs AXI_DMA/Reg] SEG_M_AXI_DMA_Reg
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x50000000 [get_bd_addr_spaces AXI_MMIO] [get_bd_addr_segs hier_pardcore_peripheral/xdma_0/S_AXI_B/BAR0] SEG_xdma_0_BAR0
  create_bd_addr_seg -range 0x20000000 -offset 0x60000000 [get_bd_addr_spaces AXI_MMIO] [get_bd_addr_segs hier_pardcore_peripheral/xdma_0/S_AXI_LITE/CTL0] SEG_xdma_0_CTL0
