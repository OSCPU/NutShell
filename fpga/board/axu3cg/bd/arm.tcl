...
proc create_hier_cell_hier_rvcore_peripheral { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_dma_rvcore_M_AXI_MM2S [get_bd_intf_pins axi_dma_rvcore/M_AXI_MM2S] [get_bd_intf_pins axi_interconnect_rvcore_dma/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_rvcore_M_AXI_S2MM [get_bd_intf_pins axi_dma_rvcore/M_AXI_S2MM] [get_bd_intf_pins axi_interconnect_rvcore_dma/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_rvcore_M_AXI_SG [get_bd_intf_pins axi_dma_rvcore/M_AXI_SG] [get_bd_intf_pins axi_interconnect_rvcore_dma/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_rvcore_mmio_M00_AXI [get_bd_intf_pins axi_interconnect_rvcore_mmio/M00_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_rvcore_mmio_M01_AXI [get_bd_intf_pins axi_dma_rvcore/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_rvcore_mmio/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_rvcore_mmio_M02_AXI [get_bd_intf_pins AXI4VGA_0/io_in_ctrl] [get_bd_intf_pins axi_interconnect_rvcore_mmio/M02_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_rvcore_mmio_M03_AXI [get_bd_intf_pins AXI4VGA_0/io_in_fb] [get_bd_intf_pins axi_interconnect_rvcore_mmio/M03_AXI]
  ...
  connect_bd_net -net M03_ARESETN_1 [get_bd_pins M03_ARESETN] [get_bd_pins axi_interconnect_rvcore_mmio/M02_ARESETN] [get_bd_pins axi_interconnect_rvcore_mmio/M03_ARESETN]
  ...
  connect_bd_net -net axi_uartlite_0_tx [get_bd_pins tx] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins uncoreclk] [get_bd_pins axi_dma_rvcore/m_axi_mm2s_aclk] [get_bd_pins axi_dma_rvcore/m_axi_s2mm_aclk] [get_bd_pins axi_dma_rvcore/m_axi_sg_aclk] [get_bd_pins axi_dma_rvcore/s_axi_lite_aclk] [get_bd_pins axi_interconnect_rvcore_dma/ACLK] [get_bd_pins axi_interconnect_rvcore_dma/M00_ACLK] [get_bd_pins axi_interconnect_rvcore_dma/S00_ACLK] [get_bd_pins axi_interconnect_rvcore_dma/S01_ACLK] [get_bd_pins axi_interconnect_rvcore_dma/S02_ACLK] [get_bd_pins axi_interconnect_rvcore_mmio/ACLK] [get_bd_pins axi_interconnect_rvcore_mmio/M00_ACLK] [get_bd_pins axi_interconnect_rvcore_mmio/M01_ACLK] [get_bd_pins axi_interconnect_rvcore_mmio/S00_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk]
  connect_bd_net -net clock_1 [get_bd_pins clock] [get_bd_pins AXI4VGA_0/clock] [get_bd_pins axi_interconnect_rvcore_mmio/M02_ACLK] [get_bd_pins axi_interconnect_rvcore_mmio/M03_ACLK]
  connect_bd_net -net rvcore_uncorerst_interconnect_aresetn [get_bd_pins ARESETN] [get_bd_pins axi_interconnect_rvcore_dma/ARESETN] [get_bd_pins axi_interconnect_rvcore_dma/M00_ARESETN] [get_bd_pins axi_interconnect_rvcore_dma/S00_ARESETN] [get_bd_pins axi_interconnect_rvcore_dma/S01_ARESETN] [get_bd_pins axi_interconnect_rvcore_dma/S02_ARESETN] [get_bd_pins axi_interconnect_rvcore_mmio/ARESETN] [get_bd_pins axi_interconnect_rvcore_mmio/M00_ARESETN] [get_bd_pins axi_interconnect_rvcore_mmio/M01_ARESETN] [get_bd_pins axi_interconnect_rvcore_mmio/S00_ARESETN]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {########################I2C 1#I2C 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#I2C 0#I2C 0#UART 1#UART 1#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#############Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {########################scl_out#sda_out#gpio1[26]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpio1[31]#gpio1[32]#gpio1[33]#scl_out#sda_out#txd#rxd#gpio1[38]#gpio1[39]#gpio1[40]#gpio1[41]#gpio1[42]#gpio1[43]#gpio1[44]#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#############rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
  ...
  connect_bd_net -net hier_clkrst_clk40 [get_bd_ports clk40] [get_bd_pins hier_clkrst/clk40] [get_bd_pins hier_rvcore_peripheral/clock]
  connect_bd_net -net hier_clkrst_coreclk [get_bd_ports coreclk] [get_bd_pins hier_clkrst/coreclk]
  connect_bd_net -net hier_clkrst_interconnect_aresetn1 [get_bd_pins hier_clkrst/interconnect_aresetn1] [get_bd_pins hier_rvcore_peripheral/M03_ARESETN]
  ...
  connect_bd_net -net hier_rvcore_peripheral_io_vga_vsync [get_bd_ports vga_vsync] [get_bd_pins hier_rvcore_peripheral/io_vga_vsync]
  connect_bd_net -net hier_rvcore_peripheral_rvcore_intrs [get_bd_ports intrs] [get_bd_pins hier_rvcore_peripheral/intrs]
  connect_bd_net -net hier_rvcore_peripheral_vga_hsync [get_bd_ports vga_hsync] [get_bd_pins hier_rvcore_peripheral/vga_hsync]
  connect_bd_net -net hier_rvcore_peripheral_vga_rgb [get_bd_ports vga_rgb] [get_bd_pins hier_rvcore_peripheral/vga_rgb]
  connect_bd_net -net hier_rvcore_peripheral_vga_valid [get_bd_ports vga_valid] [get_bd_pins hier_rvcore_peripheral/vga_valid]
  ...
  connect_bd_net -net reset_1 [get_bd_pins hier_clkrst/peripheral_reset] [get_bd_pins hier_rvcore_peripheral/reset]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins hier_clkrst/resetn] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x80001000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs hier_arm_peripheral/corerst/S_AXI/Reg] SEG_rvcore_corerst_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_rvcore_peripheral/axi_dma_rvcore/Data_SG] [get_bd_addr_segs AXI_DMA/Reg] SEG_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_rvcore_peripheral/axi_dma_rvcore/Data_MM2S] [get_bd_addr_segs AXI_DMA/Reg] SEG_AXI_DMA_Reg
  create_bd_addr_seg -range 0x010000000000 -offset 0x00000000 [get_bd_addr_spaces hier_rvcore_peripheral/axi_dma_rvcore/Data_S2MM] [get_bd_addr_segs AXI_DMA/Reg] SEG_AXI_DMA_Reg
  ...
  create_bd_addr_seg -range 0x00100000 -offset 0x50000000 [get_bd_addr_spaces AXI_MMIO] [get_bd_addr_segs hier_rvcore_peripheral/AXI4VGA_0/io_in_fb/reg0] SEG_AXI4VGA_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces AXI_MMIO] [get_bd_addr_segs hier_rvcore_peripheral/AXI4VGA_0/io_in_ctrl/reg0] SEG_AXI4VGA_0_reg01
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces AXI_MMIO] [get_bd_addr_segs hier_rvcore_peripheral/axi_dma_rvcore/S_AXI_LITE/Reg] SEG_axi_dma_rvcore_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40600000 [get_bd_addr_spaces AXI_MMIO] [get_bd_addr_segs hier_rvcore_peripheral/axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
